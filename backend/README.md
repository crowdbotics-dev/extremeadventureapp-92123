...
## Project Structure
    ...
    ├── extremeadventureapp_92123  # Django project configurations
...
1. Clone this repo and `cd extremeadventureapp_92123`
...
2. Clone this repo and `cd extremeadventureapp_92123`
